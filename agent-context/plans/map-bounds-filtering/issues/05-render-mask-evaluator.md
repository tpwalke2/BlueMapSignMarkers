...
See `07-non-box-render-mask-types.md` for the field-shape
citations and `../../map-bounds-filtering-plan.md`'s "New module: render-mask
...
- [x] Given a `.conf` file whose `render-mask` matches `../../../../run/config/bluemap/maps/world_nether_roof.conf`'s
      ...
      `01-render-mask-semantics-and-config-lookup.md`.
