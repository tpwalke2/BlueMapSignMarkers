# 03 — Document sorting/toggleable/depthTest/cssClasses in README

**What to build:** Add the four new fields to `../../../../README.md`'s Marker Groups config reference, with their type-scope
and defaults, following the existing field-list format.
