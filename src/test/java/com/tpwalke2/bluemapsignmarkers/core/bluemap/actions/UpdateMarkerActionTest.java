...
class UpdateMarkerActionTest {

    @Test
    void constructorRejectsANullLabel() {
        assertThrows(NullPointerException.class, () -> new UpdateMarkerAction(identifier(), null, "detail"));
    }

    @Test
    void constructorRejectsANullDetail() {
        assertThrows(NullPointerException.class, () -> new UpdateMarkerAction(identifier(), "label", null));
    }
